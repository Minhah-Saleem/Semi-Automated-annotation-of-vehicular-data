...
def generate_2d_lidar(image_filename):
    calib = Calib(CALIBRATION_PATH)
     # load image
    img_name = getCoord.getPictureName(image_filename)
    ...
    for i in range(len(x)):
        ...
        #     print(type(image1))
        #     io.imsave(os.path.join(DIR_PATH, "../static/images/cropped_image.png"), np.array(image1))
